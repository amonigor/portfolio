  ...
  <nav class="container" id="navbar">
    <div class="content">
      ...
      <div class="links" :class="[menu ? 'open' : '']">
        <a href="#" class="section fade-navbar-right" @click.prevent="scrollPage('home')">
          <p>{{ $t("sections.home.title") }}</p>
        </a>
        <a href="#" class="section fade-navbar-right" @click.prevent="scrollPage('about-me')">
          <p>{{ $t("sections.about.title") }}</p>
        </a>
        <a href="#" class="section fade-navbar-right" @click.prevent="scrollPage('portfolio')">
          <p>{{ $t("sections.portfolio.title") }}</p>
        </a>
        <a href="#" class="section fade-navbar-right" @click.prevent="scrollPage('contact')">
        ...
        <div class="others">
          <a
            ...
            target="_blank"
            class="social fade-navbar-right"
            title="Linkedin"
          >
          ...
          <a
            href="#"
            class="language fade-navbar-right"
